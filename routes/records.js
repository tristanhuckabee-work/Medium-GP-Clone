...
router.post('/new', csrfProtection, recordValidations, requireAuth, asyncHandler(async (req, res) => {
  ...
  if (validatorErrors.isEmpty()) {
    ...
    res.render('form', { title, description, errors, csrfToken: req.csrfToken() })
  }
}));
