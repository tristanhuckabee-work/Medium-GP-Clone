      ...
      return queryInterface.bulkInsert('Records', [
        {
          ...
          updatedAt: new Date()},
        {
          title:'rrrrrrrrrrrreeeeeeeeeaaaallllly loooooonnnnggg title',
          description:'...',
          userId:'1',
          createdAt: new Date(),
          updatedAt: new Date()},
